...
# > file edited: Sat, 22 Feb 2020 19:58:26 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105194_spinal_cord_RANDOMSHIFT_40kb/TCGAgbm_classical_neural"
