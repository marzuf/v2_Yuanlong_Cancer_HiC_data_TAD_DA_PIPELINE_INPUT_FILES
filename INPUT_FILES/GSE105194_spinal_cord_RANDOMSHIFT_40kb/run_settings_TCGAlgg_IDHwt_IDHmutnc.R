...
# > file edited: Sat, 22 Feb 2020 20:01:48 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105194_spinal_cord_RANDOMSHIFT_40kb/TCGAlgg_IDHwt_IDHmutnc"
