...
# > file edited: Sat, 22 Feb 2020 20:18:53 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR489OCU_NCI-H460_RANDOMSHIFT_40kb/TCGAluad_wt_mutKRAS"
