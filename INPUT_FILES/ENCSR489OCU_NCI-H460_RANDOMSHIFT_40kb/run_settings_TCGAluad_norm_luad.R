...
# > file edited: Sat, 15 Feb 2020 21:27:27 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR489OCU_NCI-H460_RANDOMSHIFT_40kb/TCGAluad_norm_luad"
