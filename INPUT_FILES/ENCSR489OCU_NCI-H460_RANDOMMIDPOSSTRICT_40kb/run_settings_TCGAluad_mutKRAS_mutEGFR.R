...
# > file edited: Fri, 20 Mar 2020 17:46:59 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR489OCU_NCI-H460_RANDOMMIDPOSSTRICT_40kb/TCGAluad_mutKRAS_mutEGFR"
