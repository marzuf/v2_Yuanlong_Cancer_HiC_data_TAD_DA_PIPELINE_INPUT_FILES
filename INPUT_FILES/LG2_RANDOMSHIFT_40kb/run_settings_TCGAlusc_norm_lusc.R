...
# > file edited: Sat, 22 Feb 2020 20:25:21 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/LG2_RANDOMSHIFT_40kb/TCGAlusc_norm_lusc"
