...
# > file edited: Fri, 20 Mar 2020 17:45:53 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR489OCU_NCI-H460_RANDOMMIDPOSDISC_40kb/TCGAluad_norm_luad"
