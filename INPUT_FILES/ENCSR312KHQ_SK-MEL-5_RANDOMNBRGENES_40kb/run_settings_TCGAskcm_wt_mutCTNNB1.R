...
# > file edited: Mon, 17 Feb 2020 16:37:08 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR312KHQ_SK-MEL-5_RANDOMNBRGENES_40kb/TCGAskcm_wt_mutCTNNB1"
