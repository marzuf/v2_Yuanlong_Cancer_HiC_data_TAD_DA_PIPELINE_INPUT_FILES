...
# > file edited: Sat, 21 Mar 2020 21:17:03 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/LG1_PERMUTG2T_40kb/TCGAluad_wt_mutKRAS"
