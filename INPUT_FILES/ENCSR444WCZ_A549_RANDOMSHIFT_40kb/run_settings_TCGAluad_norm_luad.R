...
# > file edited: Sat, 22 Feb 2020 20:09:51 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR444WCZ_A549_RANDOMSHIFT_40kb/TCGAluad_norm_luad"
