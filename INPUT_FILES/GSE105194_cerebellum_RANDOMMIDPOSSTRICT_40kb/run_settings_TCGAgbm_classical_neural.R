...
# > file edited: Fri, 20 Mar 2020 17:47:48 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105194_cerebellum_RANDOMMIDPOSSTRICT_40kb/TCGAgbm_classical_neural"
