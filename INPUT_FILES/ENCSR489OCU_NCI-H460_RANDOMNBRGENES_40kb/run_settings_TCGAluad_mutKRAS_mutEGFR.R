...
# > file edited: Tue, 18 Feb 2020 16:42:58 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR489OCU_NCI-H460_RANDOMNBRGENES_40kb/TCGAluad_mutKRAS_mutEGFR"
