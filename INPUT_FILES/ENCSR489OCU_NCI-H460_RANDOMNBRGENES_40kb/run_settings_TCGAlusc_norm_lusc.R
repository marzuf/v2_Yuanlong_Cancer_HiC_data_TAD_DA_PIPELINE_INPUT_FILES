...
# > file edited: Mon, 17 Feb 2020 16:20:36 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR489OCU_NCI-H460_RANDOMNBRGENES_40kb/TCGAlusc_norm_lusc"
