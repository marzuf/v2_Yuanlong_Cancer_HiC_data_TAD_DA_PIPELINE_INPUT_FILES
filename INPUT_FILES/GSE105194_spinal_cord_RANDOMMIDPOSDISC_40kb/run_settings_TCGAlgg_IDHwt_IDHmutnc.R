...
# > file edited: Fri, 20 Mar 2020 17:47:12 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105194_spinal_cord_RANDOMMIDPOSDISC_40kb/TCGAlgg_IDHwt_IDHmutnc"
