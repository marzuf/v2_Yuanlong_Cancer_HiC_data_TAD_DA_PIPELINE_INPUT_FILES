...
# > file edited: Sat, 21 Mar 2020 21:15:54 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR312KHQ_SK-MEL-5_PERMUTG2T_40kb/TCGAskcm_wt_mutCTNNB1"
