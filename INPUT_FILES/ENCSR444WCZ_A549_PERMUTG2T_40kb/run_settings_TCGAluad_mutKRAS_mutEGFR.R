...
# > file edited: Sat, 21 Mar 2020 21:16:03 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR444WCZ_A549_PERMUTG2T_40kb/TCGAluad_mutKRAS_mutEGFR"
