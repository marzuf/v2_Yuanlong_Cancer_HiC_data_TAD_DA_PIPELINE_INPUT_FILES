...
# > file edited: Sat, 21 Mar 2020 21:16:46 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105194_spinal_cord_PERMUTG2T_40kb/TCGAlgg_IDHwt_IDHmutnc"
