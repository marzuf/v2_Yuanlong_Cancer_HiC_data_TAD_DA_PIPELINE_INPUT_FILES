...
# > file edited: Mon, 17 Feb 2020 16:47:15 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105194_cerebellum_RANDOMNBRGENES_40kb/TCGAgbm_classical_neural"
