...
# > file edited: Fri, 20 Mar 2020 17:44:42 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105381_HepG2_RANDOMMIDPOSDISC_40kb/TCGAlihc_norm_lihc"
