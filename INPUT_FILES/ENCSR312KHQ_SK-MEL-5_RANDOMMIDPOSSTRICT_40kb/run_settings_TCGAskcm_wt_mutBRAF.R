...
# > file edited: Fri, 20 Mar 2020 17:46:34 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR312KHQ_SK-MEL-5_RANDOMMIDPOSSTRICT_40kb/TCGAskcm_wt_mutBRAF"
