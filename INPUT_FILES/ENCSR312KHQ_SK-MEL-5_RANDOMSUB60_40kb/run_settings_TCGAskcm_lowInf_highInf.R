# !!! EDITED MANUALLY 05.04.2020 => to take the subsampled samples !
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAskcm_lowInf_highInf_sub60/lowInf_ID.Rdata" # changed here 05.04.2020
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAskcm_lowInf_highInf_sub60/highInf_ID.Rdata" # changed here 05.04.2020
...
# > file edited: Sun, 05 Apr 2020 17:08:09 +0200 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR312KHQ_SK-MEL-5_RANDOMSUB60_40kb/TCGAskcm_lowInf_highInf"

# OVERWRITE THE DEFAULT SETTINGS FOR INPUT FILES - use TADs from the current Hi-C dataset 
TADpos_file <- paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/ENCSR312KHQ_SK-MEL-5_RANDOMSUB60_40kb/genes2tad/all_assigned_regions.txt")
#chr1    chr1_TAD1       750001  1300000
#chr1    chr1_TAD2       2750001 3650000
#chr1    chr1_TAD3       3650001 4150000

gene2tadDT_file <- paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/ENCSR312KHQ_SK-MEL-5_RANDOMSUB60_40kb/genes2tad/all_genes_positions.txt")
