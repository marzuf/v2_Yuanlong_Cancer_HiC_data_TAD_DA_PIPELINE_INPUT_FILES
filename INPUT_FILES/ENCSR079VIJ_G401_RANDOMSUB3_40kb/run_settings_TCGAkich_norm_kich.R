# 6.4.20 -> CHANGED SUBSAMPLE SAMPLE FILE
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAkich_norm_kich_sub3/norm_ID.Rdata" # changed 6.4.20 subsample file
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAkich_norm_kich_sub3/kich_ID.Rdata" # changed 6.4.20 subsample file
...
# > file edited: Mon, 06 Apr 2020 22:06:57 +0200 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR079VIJ_G401_RANDOMSUB3_40kb/TCGAkich_norm_kich"

# OVERWRITE THE DEFAULT SETTINGS FOR INPUT FILES - use TADs from the current Hi-C dataset 
TADpos_file <- paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/ENCSR079VIJ_G401_RANDOMSUB3_40kb/genes2tad/all_assigned_regions.txt")
#chr1    chr1_TAD1       750001  1300000
#chr1    chr1_TAD2       2750001 3650000
#chr1    chr1_TAD3       3650001 4150000

gene2tadDT_file <- paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/ENCSR079VIJ_G401_RANDOMSUB3_40kb/genes2tad/all_genes_positions.txt")
