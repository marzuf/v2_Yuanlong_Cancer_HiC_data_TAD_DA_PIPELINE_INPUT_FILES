...
# > file edited: Mon, 17 Feb 2020 16:41:15 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR444WCZ_A549_RANDOMNBRGENES_40kb/TCGAluad_wt_mutKRAS"
