...
# > file edited: Mon, 17 Feb 2020 16:54:12 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/LG1_RANDOMNBRGENES_40kb/TCGAlusc_norm_lusc"
