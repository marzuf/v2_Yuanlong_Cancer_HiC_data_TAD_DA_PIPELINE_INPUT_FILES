...
# > file edited: Sat, 21 Mar 2020 21:17:17 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/LG2_PERMUTG2T_40kb/TCGAlusc_norm_lusc"
