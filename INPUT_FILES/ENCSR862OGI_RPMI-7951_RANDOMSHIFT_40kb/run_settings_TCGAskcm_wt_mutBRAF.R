...
# > file edited: Sat, 22 Feb 2020 20:05:19 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR862OGI_RPMI-7951_RANDOMSHIFT_40kb/TCGAskcm_wt_mutBRAF"
