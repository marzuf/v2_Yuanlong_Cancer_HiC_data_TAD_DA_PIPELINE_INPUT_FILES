# 28.04.2020 subsampled samples file
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAlihc_wt_mutCTNNB1_sub3_5/wt_ID.Rdata" # 28.04.2020 subsampled samples file
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAlihc_wt_mutCTNNB1_sub3_5/mutCTNNB1_ID.Rdata" # 28.04.2020 subsampled samples file
...
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105381_HepG2_RANDOMSUB3-5_40kb/TCGAlihc_wt_mutCTNNB1"

# OVERWRITE THE DEFAULT SETTINGS FOR INPUT FILES - use TADs from the current Hi-C dataset 
TADpos_file <- paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/GSE105381_HepG2_RANDOMSUB3-5_40kb/genes2tad/all_assigned_regions.txt")
#chr1    chr1_TAD1       750001  1300000
#chr1    chr1_TAD2       2750001 3650000
#chr1    chr1_TAD3       3650001 4150000

gene2tadDT_file <- paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/GSE105381_HepG2_RANDOMSUB3-5_40kb/genes2tad/all_genes_positions.txt")
