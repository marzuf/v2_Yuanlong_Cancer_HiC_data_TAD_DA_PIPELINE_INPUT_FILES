...
# > file edited: Mon, 17 Feb 2020 16:25:38 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105381_HepG2_RANDOMNBRGENES_40kb/TCGAlihc_norm_lihc"
