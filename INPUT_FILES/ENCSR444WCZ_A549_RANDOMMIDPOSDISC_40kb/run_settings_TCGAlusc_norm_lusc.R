...
# > file edited: Fri, 20 Mar 2020 17:46:20 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR444WCZ_A549_RANDOMMIDPOSDISC_40kb/TCGAlusc_norm_lusc"
