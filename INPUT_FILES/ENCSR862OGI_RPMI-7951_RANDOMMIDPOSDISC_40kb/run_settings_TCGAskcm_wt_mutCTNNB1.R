...
# > file edited: Fri, 20 Mar 2020 17:45:46 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR862OGI_RPMI-7951_RANDOMMIDPOSDISC_40kb/TCGAskcm_wt_mutCTNNB1"
