...
# > file edited: Fri, 20 Mar 2020 17:47:37 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE118514_22Rv1_RANDOMMIDPOSSTRICT_40kb/TCGAprad_norm_prad"

# OVERWRITE THE DEFAULT SETTINGS FOR INPUT FILES - use TADs from the current Hi-C dataset 
TADpos_file <- paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/GSE118514_22Rv1_RANDOMMIDPOSSTRICT_40kb/genes2tad/all_assigned_regions.txt")
#chr1    chr1_TAD1       750001  1300000
#chr1    chr1_TAD2       2750001 3650000
#chr1    chr1_TAD3       3650001 4150000

gene2tadDT_file <- paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/GSE118514_22Rv1_RANDOMMIDPOSSTRICT_40kb/genes2tad/all_genes_positions.txt")
