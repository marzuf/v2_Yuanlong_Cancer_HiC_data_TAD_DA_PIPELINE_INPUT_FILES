...
# > file edited: Fri, 20 Mar 2020 17:49:35 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/LG1_RANDOMMIDPOS_40kb/TCGAlusc_norm_lusc"
