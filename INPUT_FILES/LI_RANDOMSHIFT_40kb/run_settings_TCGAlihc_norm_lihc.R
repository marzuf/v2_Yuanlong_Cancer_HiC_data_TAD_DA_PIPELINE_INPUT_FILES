...
# > file edited: Fri, 21 Feb 2020 20:43:30 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/LI_RANDOMSHIFT_40kb/TCGAlihc_norm_lihc"
